    ...
    <div style={styles.formContainer}>
      ...
      <div style={styles.formGroup}>
        ...
        <input
          type="text"
          id="itemName"
          placeholder="Eşya adını giriniz"
          value={itemName}
      ...
      <div style={styles.formGroup}>
        <label style={styles.label} htmlFor="importance">
          Önem Derecesi
        </label>
        <select
          id="importance"
      ...
      <div style={styles.formGroup}>
        <label style={styles.label} htmlFor="assignmentDate">
          Atama Tarihi
        </label>
        <input
          type="date"
      ...
      <div style={styles.formGroup}>
        ...
        <textarea
          id="description"
          placeholder="Eşya ile ilgili açıklama giriniz"
          value={description}
