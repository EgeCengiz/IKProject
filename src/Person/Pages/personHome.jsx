                    ...
                    <div class="tab-content text-muted bg-white">
                          ...
                          <div class="col-md-6 col-sm-6 col-md-6 mb-0">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                <div class="card border">
                                  <div class="card-body">
                                    <h6 class="m-0 fw-semibold text-dark fs-16">Sahil Net Projesi</h6>
                              ...
                              <ol class="profile-section list-unstyled mb-0 px-4">
                                <li class="profile-item">
                                  <div class="avatar-sm profile-icon p-1">
                                    <div class="avatar-title rounded-2 bg-light" style={{ height: 35, width: 35 }}>
                      ...
                      <div class="tab-pane pt-4" id="profile_education" role="tabpanel">
                        <div class="row">
                          ...
                          <div class="col-md-12 col-sm-12 col-lg-12 d-flex align-items-top justify-content-between">
                          ...
                          <div class="row">
                            <div class="col-4">
                              <ol class="profile-section list-unstyled mb-0 px-4">
                                <li class="profile-item">
                                  <div class="avatar-sm profile-icon p-1">
                                    <div class="avatar-title rounded-2 bg-light" style={{ height: 40, width: 40 }}>
                              ...
                              <div class="card border mb-0">
                                ...
                                <div class="card-header">
                                  <div class="row align-items-center">
                                    <div class="col">
                                      <h4 class="card-title p-1">Personel Bilgileri</h4>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="card-body">
                                  <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                      <input class="form-control" type="text" value="Ege" />
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                      <input class="form-control" type="text" value="Ortakcı" />
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                      <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="egecengiz@smartict.com" placeholder="Email" aria-describedby="basic-addon1" />
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                      <input class="form-control" type="text" value="Turkey" />
                                    </div>
                                  </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col fs-13 text-muted text-center">
                &copy; <script>document.write(new Date().getFullYear())</script> - <a href="#!" class="text-reset fw-semibold">SmartICT</a>
              </div>
            </div>
          </div>
        </footer>
