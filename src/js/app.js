...
class App {
    ...
    initMenu() {
        var self = this;
        var body =document.querySelector('app-sidebar-menu');
        ...
        if (menuToggleBtn) {
            menuToggleBtn.addEventListener('click', function () {
                ...
                if (document.querySelector('app-sidebar-menu').getAttribute('data-sidebar') == 'default') {
                    document.querySelector('app-sidebar-menu').setAttribute('data-sidebar', 'hidden');
                } else {
                    document.querySelector('app-sidebar-menu').setAttribute('data-sidebar', 'default');
                }
            });
        }
